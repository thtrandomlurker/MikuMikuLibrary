...
public abstract partial class Node<T> : INode where T : class
{
    ...
    private static readonly Dictionary<string, PropertyInfo> sPropertyInfos = new(StringComparer.OrdinalIgnoreCase);
    ...
    [Category("Debug")] [Browsable(false)] public abstract NodeFlags Flags { get; }

    object INode.Data => Data;

    [Category("Debug")] [Browsable(false)] public Type DataType => typeof(T);
    ...
    [Category("Debug")] [Browsable(false)] public IList<INode> Nodes => mNodes;
    ...
    public ContextMenuStrip ContextMenuStrip =>
        mContextMenuStrip ??= CreateContextMenuStrip();

    [Category("Debug")] [Browsable(false)] public virtual Control Control { get; }

    [Category("Debug")] [Browsable(false)] public object Tag { get; set; }

    [Category("Debug")] [Browsable(false)] public Configuration SourceConfiguration { get; set; }
